...
class LocalIndexedStorage {
  ...
  static open(dbName='Currency-Converter-Code-Challenge', version=1) {
    return new Promise((resolve, reject) => {
      if (!window.indexedDB) {
        const message = "If Your browser doesn't support a stable version of IndexedDB. Your app wont work completely offline ok?";
  ...
  static setItem(key, value, db) {
    return new Promise((resolve, reject) => {
      ...
      transaction.oncomplete = () => console.log('Saving completed');
